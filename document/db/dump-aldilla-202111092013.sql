...
DROP TABLE IF EXISTS `tbl_kurs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_kurs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kode` varchar(5) NOT NULL,
  `kurs` decimal(13,2) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tbl_kurs_un` (`kode`)
...
LOCK TABLES `tbl_kurs` WRITE;
/*!40000 ALTER TABLE `tbl_kurs` DISABLE KEYS */;
INSERT INTO `tbl_kurs` VALUES (1,'USD',14000.00);
/*!40000 ALTER TABLE `tbl_kurs` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-09 20:13:45
